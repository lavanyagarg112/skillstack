    ...
    <div className="w-full max-w-4xl bg-white p-8 rounded-2xl shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="space-y-6">
          <h3 className="text-xl font-medium text-gray-800 border-b pb-2">
            Skills
          </h3>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <select
                        ...
                        onChange={(e) =>
                          handleUpdateSkill(userSkill.skill_id, e.target.value)
                        }
              ...
              <div className="space-y-2">
                {userChannels.map((userChannel) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        handleRemoveChannel(userChannel.channel_id)
                      }
                      className="text-red-600 hover:text-red-800 focus:outline-none"
                    >
                      <svg
      ...
      {error && (
        <div className="text-red-600 text-sm mt-6 text-center bg-red-50 p-3 rounded">
          {error}
        </div>
      )}
      {message && (
